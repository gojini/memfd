...
func TestCreateFlags(t *testing.T) {
	...
	mfd, err := memfd.CreateNameFlags("test", memfd.Cloexec)
	if err != nil {
...
func TestSealing(t *testing.T) {
	...
	err = mfd.SetSeals(memfd.SealWrite)
	if err != nil {
		t.Errorf("SetSeals failed: %v", err)
	}

	seals = mfd.Seals()
	if seals != memfd.SealWrite {
...
func TestResize(t *testing.T) {
	...
	err = mfd.SetSeals(memfd.SealShrink)
	if err != nil {
		t.Errorf("SetSeals failed: %v", err)
	}
	...
	err = mfd.SetSeals(memfd.SealGrow)
	if err != nil {
		t.Errorf("SetSeals failed: %v", err)
	}
